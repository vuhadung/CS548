...
public class TreatmentRepresentation extends TreatmentType {
	...
	public TreatmentRepresentation(TreatmentDto dto, UriInfo uriInfo) {
		this();
		this.id = TreatmentRepresentation
				.getTreatmentLink(dto.getId(), uriInfo);
		...
		if (dto.getDrugTreatment() != null) {
			this.drugTreatment = new DrugTreatmentRepresentation();
	...
	public TreatmentDto getTreatment() {
		...
		if (this.getDrugTreatment() != null) {
			m = treatmentDtoFactory.createNewDrugTreatmentDto(
					this.drugTreatment.getName(),
					this.drugTreatment.getDosage());
		} else if (this.getSurgery() != null) {
			m = treatmentDtoFactory.createNewRadiologyDto(this.radiology
					.getDate());
		} else if (this.getRadiology() != null) {
			m = treatmentDtoFactory.createNewSurgeryDto(this.surgery.getDate());
		}
